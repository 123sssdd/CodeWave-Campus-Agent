export const FAQList = {
  ...
  FAQ_ZH: [
    {
      question: "AC这款AI助手与deepseek、豆包等有何不同?",
      answer:
    ...
    {
      question: "我是计算机爱好者，没有经过系统的学习，适合使用ai码吗?",
      answer:
    ...
    //   question: "你们提供定制服务吗？",
    //   answer:
    //     "我们接受落地页的定制开发服务。请通过电子邮件karma.zhao@gmail.com或Twitter @huglemon与我们联系。",
    // },
    // {
    ...
    //   answer:
    //     "如果你在使用模板时遇到任何问题，请通过Twitter @huglemon 与我们联系。",
    // },
  ],
