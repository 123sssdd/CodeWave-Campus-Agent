		...
		<>
			...
			>
				...
				>
					...
					<h1 className='font-bold text-5xl md:text-7xl bg-gradient-to-r from-base-...'>
					...
					<div className='w-full md:w-8/12 mx-auto flex flex-col md:flex-row md:items-center justify-between gap-y-5'>
						...
						<div className='flex flex-col md:flex-row gap-2'>
							<a
								...
								href='https://github.com/123sssdd/CodeWave-Campus-Agent'
							>
								<SiGithub />
								{CTALocale.btn1}
							</a>
							<a
								...
								href='https://jcnm38jrux4j.feishu.cn/wiki/BfA7wD4jdikYfpkc1mBcCs4Dnsg'
							>
