...
input_file = r"../../语音交互、图片识别、文本聊天的成功接口/图片识别、语音交互测试上传的文件/语音交互示例语音2.wav"
audio_file_path = r"/语音交互、图片识别、文本聊天的模块demo/语音交互示例的output\语音交互示例的output"
...
def recv_data(ws):
    # 加载音频文件
    audio_array = []
    # with open('语音交互示例的output.pcm', 'wb') as f:
    while True:
        result = ws.recv()
